    ...
    people: [
      {
        ...
        st: { band: 0, reviewFee: 0, gstReg: false, basCount: 0, basRecords: 'complete' },
      ...
      },
      {
        ...
        st: { band: 1, reviewFee: 0, gstReg: true, basCount: 2, basRecords: 'complete' },
        rentals: [],
        shares: { mode: 'none', brokerCount: 1, disposalCount: 0, completeReportSupplied: false, complexReview: false, estimate: 0 },
        cfd: { on: false, brokerCount: 1, annualSummarySupplied: true, foreignCurrency: false, reconstructionRequired: false, highVolumeReview: false, estimate: 0 },
        crypto: { mode: 'none', estimate: 0 },
...
const SAMPLE_COMPANY = {
  ...
  data: {
    ...
    payrollFreq: 'Monthly',
    payrollTier: '1–3',
    bookMode: 'Complete reconciled records supplied',
    cleanup: false,
    support: 'planning',
    entitySetup: 'No – entity already exists',
    setupsMulti: [],
    properties: 1,
    shareVol: 'standard',
    shareQuote: 0,
    ...
    contact: 'Amrit Kaur',
    phone: '0400 333 444',
    email: 'accounts@melbmotors.example.com',
    abn: '12 345 678 901',
    preparedBy: 'Test Manager',
  },
};
